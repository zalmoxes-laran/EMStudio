...
const EN: Dict = {
  ...
  "ws.dtc": "DTC",
  "ws.dtcHint": "DTC — Documentation, Transformation, Communication: the provenance DAG of the corpus (acquisitions → derivations → attributions), with the Inspector beside it.",
...
const IT: Dict = {
  ...
  "ws.dtc": "DTC",
  "ws.dtcHint": "DTC — Documentation, Transformation, Communication: il DAG della provenienza del corpus (acquisizioni → derivazioni → attribuzioni), con l'Ispettore a lato.",
