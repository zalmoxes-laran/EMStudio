...
const EN: Dict = {
  ...
  // ── HDT-O · the attribution, and the three states it can be in ────────────
  //
  // The words a director of excavations reads. The CODES (HC9, HC1, HC2, HC13)
  // are in the glossary tooltips, never on a label: they are what the ontology
  // and the papers use, and they say nothing to the person filling the form.
  //
  // And the one sentence that matters: NOT KNOWING YET IS NORMAL. The old hint
  // called the twin «optional» — the thing that gives a site its identity,
  // described as a checkbox — and said nothing about what it is for.
  "insp.hdt": "Which monument this study is about",
  "insp.hdtHint":
    "Naming the monument, site or landscape is what makes eight campaigns ONE place instead of eight unrelated documents — and what lets other people find your work next to theirs. Not knowing yet is normal: leave it, keep digging, and say it later.",
  "insp.hdtStudy": "This study",
  "insp.hdtStudyGloss": "HC9 · Study — the campaign, the season, the piece of work this graph records.",
  "insp.hdtStudyTitle": "Title",
  "insp.hdtStudyTitlePh": "e.g. Aiano, 2026 campaign",
  "insp.hdtStudyAuthors": "Author(s)",
  "insp.hdtStudyAuthorsPh": "e.g. Rossi, Bianchi",
  "insp.hdtStudyDate": "Date",
  "insp.hdtStudyDatePh": "e.g. 2026",
  "insp.hdtEntity": "The thing in the world",
  "insp.hdtEntityGloss": "HC1 · Heritage entity — the monument, site or landscape itself, as opposed to any digital record of it.",
  "insp.hdtEntityName": "Name",
  "insp.hdtEntityNamePh": "e.g. Villa di Aiano",
  "insp.hdtParent": "Part of",
  "insp.hdtParentPh": "the whole it belongs to, e.g. Poggibonsi",
  "insp.hdtTwin": "Its digital twin",
  "insp.hdtTwinGloss": "HC2 · Heritage Digital Twin — the shared digital record of that thing, which several studies can hang on.",
  "insp.hdtProject": "The project",
  "insp.hdtProjectGloss": "HC13 · Project — the funded or institutional frame the study was made in.",
  "insp.hdtProjectName": "Name",
  "insp.hdtProjectNamePh": "optional",
  "insp.hdtProjectHint":
    "Free text, and deliberately so: the authority files behind the fields above answer «where», «when», «what kind» and «who», and a research project is none of those. Hanging it on the nearest one would make it LOOK resolved. A project register (CORDIS, ROR, a grant DOI) needs a facet of its own first.",
  // the authority sub-field, shared by the entity and its whole
  "insp.authority": "Authority",
  "insp.authorityPlaceholder": "type to search an authority, or paste a URI",
  "insp.authorityOffline": "Offline resolver: type a term, pick a match, or paste a URI.",
  "insp.authorityNoResolver": "Paste an authority URI (resolver unavailable).",
  "insp.authorityUnresolved": "Free text — not resolved against an authority.",
  // the three states
  "insp.twinStateNone": "Not attributed yet",
  "insp.twinStateNoneHint":
    "You are digging and do not yet know what this belongs to. That is a state, not a blank: nothing below has to be filled in for the rest of the study to work.",
  "insp.twinStateProvisional": "Provisional twin",
  "insp.twinStateProvisionalHint":
    "One you made yourself, so you had somewhere to put what you are finding — an ordinary thing to do. It lives in this document only; at publication it can be declared new, or recognised as somebody else's.",
  "insp.twinStateRegistered": "Registered twin",
  "insp.twinStateRegisteredHint":
    "Known by a register ({registry}), so other people find it and their campaigns can be read beside yours.",
  "insp.twinName": "Name of the twin",
  "insp.twinNamePh": "e.g. Villa di Aiano HDT",
  "insp.twinKey": "Shared identity",
  "insp.twinDetach": "This is not the one",
  "insp.twinDetachTitle": "Detaches the twin from this study. Nothing else is deleted — the study, the entity and the graph stay exactly as they are.",
  "insp.twinNeedsEntity":
    "Give the thing a name first, however roughly — a twin is a twin OF something, so «an unnamed building under the north field» is enough to start one.",
  "insp.twinCreate": "Create a provisional twin",
  "insp.twinCreateTitle": "Somewhere of your own to put what you are finding. It can be published later, and merged with an existing twin if it turns out to be the same thing.",
  "insp.twinFallbackName": "Heritage",
  "insp.twinSearch": "Is there one already?",
  "insp.twinSearchPh": "monument name, or paste an identifier",
  "insp.twinLook": "Look",
  "insp.twinSearching": "asking the register…",
  "insp.twinSearchHint":
    "A suggestion, never an obligation: you can create your own, or leave it for later.",
  "insp.twinNoRegister":
    "No register answered — that is not the same as «there is none». You can still create a provisional twin.",
  "insp.twinNoneFound": "No twin found for “{term}” in {sources}.",
  "insp.twinAbsentSource": "{label}: not configured — it was not asked.",
  "insp.twinStudies": "{n} studies",
  "insp.twinNoCustodian": "no author recorded",
  "insp.twinProvisionalWarning": "provisional — somebody else's working record",
  "insp.twinUntwinned": "{n} studies in that register have no twin yet.",
  "insp.selectNode": "Select a node to inspect it",
  ...
  "menu.shelfOpen": "Open a shelf…",
  "menu.shelfSave": "Save the shelf",
  "menu.shelfClear": "Empty the shelf",
  "menu.region": "Region",
  ...
  "conn.starvedReadOnly": "«{name}» subscribed to the changes, but this room does not let this client write ({role}) — it would show a study that never moves.",
  ...
  // ── CONDIVIDI · a LINK to the node's panel, never a copy of it ─────────────

  "share.open": "Share this room…",
  "share.openTitle": "Who is at this table, and whose the live copy is. Opens the node's panel for this room, in a new tab — that is where the ACL and the owner live, and where people, teams, invitations and the transfer are all in one place. EMStudio used to draw its own; it showed people but not teams, so it was retired.",
  "share.noRoom": "There is no room to share: this document is on your disk, and the node knows nothing about it. Bring it into a room first (File ▸ Bring this into a new room…).",
  ...
  "ident.lostTitle": "{who} — back to Signature: {node} is not answering ({why}). You can keep working; what you sign is attributed to your declared name until a node confirms it again.",
  "ident.nextJoin": "Next rung: a room. Open a room link, or set the hub in Settings ▸ Sync.",
  "ident.presenceNow": "You are in {room} as {role}. Leaving the room drops you back to a confirmed identity.",
  "ident.nodeOpen": "{server} runs with no sign-in, so there is nobody to be there. Your signature stays a signature.",
  "ident.signInFailed": "The sign-in did not complete: {why}",
  "study.ambiguous": "That link names two different studies, so nothing was opened.",
  ...
  "assets.drop": "Drop files here — or drag them from the disk pane — and they go into «{room}» at once, each carrying the delivery above. One drop is one LOT: they arrive together, as one acquisition, and everything is refinable afterwards.",
  ...
  "assets.lotHint": "Worth typing. An unnamed lot is still ONE lot — this delivery mints its own id — but the corpus labels it the moment the first file lands, so a lot of three hundred photographs ends up reading «Acquisition of 1 file(s)». A name replaces that, and dropping more files under the same name joins them to it.",
  ...
  "assets.delivery": "The delivery — signed before dragging",
  "assets.depositor": "Depositor",
  "assets.depositorHint": "Not a field: it comes from your token, and the server takes the attributor from there. There is nowhere here to type a name that is not yours.",
  "assets.editor": "Editor",
  "assets.editorMe": "me — {who}",
  "assets.editorMeHint": "Whoever answers for having published this. Recorded already: it is the attributor of every statement in this delivery.",
  "assets.editorOther": "somebody else",
  "assets.editorName": "The editor",
  "assets.editorPlaceholder": "who answers for publishing this",
  "assets.editorNotYet": "The acts carry the AUTHOR (who made it) and the ATTRIBUTOR (who says so, from your token) and nothing else — an editor who is not you has no place in the register yet. Writing it into a metadata bag would look recorded and would never be read. Say «me», or wait for the field.",
  "assets.authorIsMe": "It was me",
  "assets.authorIsMeHint": "Fills the author with your own identity. A click, on purpose: a pre-filled author asserts that whoever is logged in made the files, and one often deposits what a colleague made.",
  "assets.licensePlaceholder": "required — no licence is chosen for you",
  "assets.licenseOffer": "Use {license}",
  "assets.licenseOfferHint": "What StratiGraph publishes under when somebody chooses it. Offered, never preselected: a licence nobody picked is a legal statement nobody made.",
  "assets.needsLicense": "Choose a licence: the delivery is not signed without one, and a preselected licence would be a statement nobody made.",
  "assets.embargo": "Embargo until",
  "assets.embargoHint": "Optional. While it runs, the bytes are for the people working on them — editor and above — and everyone else is told the date rather than that the file does not exist.",
  "assets.embargoReason": "Why",
  "assets.embargoReasonPlaceholder": "why these bytes wait",
  "assets.deliverySigned": "Signed — every file that lands inherits this.",
  "assets.debt": "{stored} deposited, {signed} signed.",
  "assets.debtHint": "{n} files are in the store with nothing said about who made them or what may be done with them. This count does not go away when you clear the list.",
  "assets.state.pending": "{n} waiting",
  "assets.state.stored": "{n} deposited",
  "assets.state.signed": "{n} signed",
  "assets.state.failed": "{n} failed",
  ...
  "sync.acceptLabel": "Accept",
  "sync.acceptHint": "What you let the host land in THIS window. Nothing is held back on the way out any more: what you do not send is invisible to the other end, while what you refuse on arrival is something you can see yourself refusing.",
  "sync.accept.nothing": "Nothing",
  "sync.accept.selection": "Selection only",
  "sync.accept.everything": "Everything",
  "sync.acceptTitle.nothing": "nothing from the host lands here; yours still leaves, and the host decides what it takes",
  "sync.acceptTitle.selection": "the host's selection lands here; its graph edits do not",
  "sync.acceptTitle.everything": "selection and graph edits both land here",
  "sync.acceptLogged": "accepting from the host: {what}",
  "sync.hostAcceptTag": "host accepts",
  "sync.hostAcceptHint": "The host is refusing some of what this client sends. What you send is arriving and being refused there — it is not getting lost on the way.",
  "sync.differentDocs": "The two ends are on DIFFERENT documents: {what}. A node id from over there will not be found here — this is not an error, but it is why nothing seems to arrive.",
  "sync.differentDocsToast": "Different documents on the two ends — see the log",
  "sync.differentDocsTag": "different doc",
  "sync.differentDocsHint": "The host and this client have different graphs open. Working on different documents is legitimate; not knowing it is what makes the channel look broken.",
  ...
  "shelf.empty": "The shelf is empty. Drag a file here from the Storage window, or add an address with + URI in this window’s header. The browser shows every file on the disk; the shelf holds the ones you chose.",
  ...
  "shelf.nameTitle": "The name of this shelf — it travels with the ShelfGraph when you save it",
  "shelf.addUri": "+ URI",
  "shelf.addUriTitle": "Put an address on the shelf (URI/LOD)",
  "shelf.uriPlaceholder": "https://… (URI/LOD)",
...
const IT: Dict = {
  ...
  // ── HDT-O · l'attribuzione e i suoi tre stati ─────────────────────────────
  "insp.hdt": "Di che monumento parla questo studio",
  "insp.hdtHint":
    "Dare un nome al monumento, al sito o al paesaggio è ciò che fa di otto campagne UN luogo solo invece di otto documenti scollegati — ed è ciò che permette agli altri di trovare il tuo lavoro accanto al loro. Non saperlo ancora è normale: lascia stare, continua a scavare, e dillo più avanti.",
  "insp.hdtStudy": "Questo studio",
  "insp.hdtStudyGloss": "HC9 · Study — la campagna, la stagione, il lavoro che questo grafo registra.",
  "insp.hdtStudyTitle": "Titolo",
  "insp.hdtStudyTitlePh": "es. Aiano, campagna 2026",
  "insp.hdtStudyAuthors": "Autore/i",
  "insp.hdtStudyAuthorsPh": "es. Rossi, Bianchi",
  "insp.hdtStudyDate": "Data",
  "insp.hdtStudyDatePh": "es. 2026",
  "insp.hdtEntity": "La cosa nel mondo",
  "insp.hdtEntityGloss": "HC1 · Heritage entity — il monumento, il sito o il paesaggio in sé, distinto da qualunque sua registrazione digitale.",
  "insp.hdtEntityName": "Nome",
  "insp.hdtEntityNamePh": "es. Villa di Aiano",
  "insp.hdtParent": "Parte di",
  "insp.hdtParentPh": "l'insieme a cui appartiene, es. Poggibonsi",
  "insp.hdtTwin": "Il suo gemello digitale",
  "insp.hdtTwinGloss": "HC2 · Heritage Digital Twin — la registrazione digitale condivisa di quella cosa, a cui più studi possono appendersi.",
  "insp.hdtProject": "Il progetto",
  "insp.hdtProjectGloss": "HC13 · Project — la cornice finanziata o istituzionale in cui lo studio è stato fatto.",
  "insp.hdtProjectName": "Nome",
  "insp.hdtProjectNamePh": "facoltativo",
  "insp.hdtProjectHint":
    "Testo libero, e per scelta: gli authority file dietro ai campi qui sopra rispondono a «dove», «quando», «di che tipo» e «chi», e un progetto di ricerca non è nessuna di queste cose. Agganciarlo alla faccetta più vicina lo farebbe SEMBRARE risolto. Un registro dei progetti (CORDIS, ROR, il DOI di un grant) ha bisogno prima di una faccetta sua.",
  "insp.authority": "Authority",
  "insp.authorityPlaceholder": "scrivi per cercare in un authority file, o incolla una URI",
  "insp.authorityOffline": "Resolver offline: scrivi un termine, scegli una corrispondenza, o incolla una URI.",
  "insp.authorityNoResolver": "Incolla una URI di authority (resolver non disponibile).",
  "insp.authorityUnresolved": "Testo libero — non risolto su un authority file.",
  "insp.twinStateNone": "Non ancora attribuito",
  "insp.twinStateNoneHint":
    "Stai scavando e non sai ancora a cosa pertiene. È uno stato, non una casella vuota: niente di quanto segue deve essere compilato perché il resto dello studio funzioni.",
  "insp.twinStateProvisional": "Gemello provvisorio",
  "insp.twinStateProvisionalHint":
    "Te lo sei creato tu, perché ti serviva un posto dove mettere quello che stai trovando — cosa normalissima. Vive solo in questo documento; alla pubblicazione si potrà dire che è nuovo, oppure riconoscere che è quello di qualcun altro.",
  "insp.twinStateRegistered": "Gemello registrato",
  "insp.twinStateRegisteredHint":
    "Lo conosce un registro ({registry}), quindi gli altri lo trovano e le loro campagne si leggono accanto alla tua.",
  "insp.twinName": "Nome del gemello",
  "insp.twinNamePh": "es. Villa di Aiano HDT",
  "insp.twinKey": "Identità condivisa",
  "insp.twinDetach": "Non è questo",
  "insp.twinDetachTitle": "Stacca il gemello da questo studio. Non cancella nient'altro: lo studio, l'entità e il grafo restano esattamente come sono.",
  "insp.twinNeedsEntity":
    "Prima dai un nome alla cosa, anche approssimativo — un gemello è il gemello DI qualcosa, quindi «un edificio senza nome sotto il campo nord» basta e avanza per cominciare.",
  "insp.twinCreate": "Crea un gemello provvisorio",
  "insp.twinCreateTitle": "Un posto tuo dove mettere quello che stai trovando. Si potrà pubblicare più avanti, e fondere con un gemello esistente se si rivelerà la stessa cosa.",
  "insp.twinFallbackName": "Bene culturale",
  "insp.twinSearch": "Ne esiste già uno?",
  "insp.twinSearchPh": "nome del monumento, o incolla un identificatore",
  "insp.twinLook": "Cerca",
  "insp.twinSearching": "sto interrogando il registro…",
  "insp.twinSearchHint":
    "Un suggerimento, mai un obbligo: puoi crearne uno tuo, o rimandare.",
  "insp.twinNoRegister":
    "Nessun registro ha risposto — che non vuol dire «non ce n'è». Puoi comunque creare un gemello provvisorio.",
  "insp.twinNoneFound": "Nessun gemello trovato per “{term}” in {sources}.",
  "insp.twinAbsentSource": "{label}: non configurato — non è stato interrogato.",
  "insp.twinStudies": "{n} studi",
  "insp.twinNoCustodian": "nessun autore registrato",
  "insp.twinProvisionalWarning": "provvisorio — appunto di lavoro di qualcun altro",
  "insp.twinUntwinned": "In quel registro {n} studi non hanno ancora un gemello.",
  "insp.selectNode": "Seleziona un nodo per ispezionarlo",
  ...
  "menu.shelfOpen": "Apri uno shelf…",
  "menu.shelfSave": "Salva lo shelf",
  "menu.shelfClear": "Svuota lo shelf",
  "menu.region": "Regione",
  ...
  "conn.starvedReadOnly": "«{name}» si è iscritto ai cambiamenti, ma questa stanza non lascia scrivere a questo client ({role}) — vedrebbe uno studio che non si muove mai.",
  ...
  "share.open": "Condividi questa stanza…",
  "share.openTitle": "Chi è a questo tavolo, e di chi è la copia viva. Apre il pannello del nodo per questa stanza, in una scheda nuova — là vivono l'ACL e il proprietario, e persone, squadre, inviti e trasferimento stanno in un posto solo. EMStudio ne disegnava uno suo; mostrava le persone e non le squadre, quindi è stato ritirato.",
  "share.noRoom": "Non c'è nessuna stanza da condividere: questo documento è sul tuo disco, e il nodo non ne sa niente. Portalo prima in una stanza (File ▸ Porta questo in una stanza nuova…).",
  ...
  "ident.lostTitle": "{who} — sceso a Firma: {node} non risponde ({why}). Puoi continuare a lavorare; quel che firmi è attribuito al tuo nome dichiarato finché un nodo non lo riconferma.",
  "ident.nextJoin": "Gradino successivo: una stanza. Apri il link di una stanza, o imposta l'hub in Impostazioni ▸ Sync.",
  "ident.presenceNow": "Sei in {room} come {role}. Uscendo dalla stanza torni a un'identità confermata.",
  "ident.nodeOpen": "{server} gira senza login, quindi non c'è nessuno da essere. La tua firma resta una firma.",
  "ident.signInFailed": "Il login non è andato a termine: {why}",
  "study.ambiguous": "Quel link nomina due studi diversi, quindi non ho aperto niente.",
  ...
  "assets.drop": "Lascia qui i file — o trascinali dal riquadro del disco — e vanno subito in «{room}», ognuno con la consegna qui sopra. Un trascinamento è un LOTTO: arrivano insieme, come una sola acquisizione, e tutto resta raffinabile dopo.",
  ...
  "assets.lotHint": "Conviene scriverlo. Un lotto senza nome è comunque UN lotto — questa consegna si fa il suo id — ma il corpus lo etichetta appena atterra il primo file, quindi un lotto di trecento foto finisce per leggersi «Acquisition of 1 file(s)». Un nome lo sostituisce, e trascinando altri file con lo stesso nome si aggiungono a quello.",
  ...
  "assets.delivery": "La consegna — si firma prima di trascinare",
  "assets.depositor": "Deposita",
  "assets.depositorHint": "Non è un campo: viene dal tuo token, e il server prende l'attributore da lì. Qui non c'è dove scrivere un nome che non è il tuo.",
  "assets.editor": "Editore",
  "assets.editorMe": "io — {who}",
  "assets.editorMeHint": "Chi risponde di aver pubblicato. È già registrato: è l'attributore di ogni affermazione di questa consegna.",
  "assets.editorOther": "qualcun altro",
  "assets.editorName": "L'editore",
  "assets.editorPlaceholder": "chi risponde di questa pubblicazione",
  "assets.editorNotYet": "Gli atti portano l'AUTORE (chi l'ha fatto) e l'ATTRIBUTORE (chi lo dice, dal tuo token), e nient'altro — un editore che non sei tu non ha ancora posto nel registro. Scriverlo in un sacchetto di metadati sembrerebbe registrato e non verrebbe mai letto. Metti «io», o aspetta il campo.",
  "assets.authorIsMe": "Sono io",
  "assets.authorIsMeHint": "Mette la tua identità come autore. Un clic, di proposito: un autore precompilato afferma che chi è connesso ha FATTO i file, e spesso si deposita quel che ha fatto un collega.",
  "assets.licensePlaceholder": "obbligatoria — nessuna licenza è scelta per te",
  "assets.licenseOffer": "Usa {license}",
  "assets.licenseOfferHint": "Quella con cui StratiGraph pubblica quando qualcuno la sceglie. Offerta, mai preselezionata: una licenza che nessuno ha scelto è un'affermazione giuridica che nessuno ha fatto.",
  "assets.needsLicense": "Scegli una licenza: senza, la consegna non si firma — e una licenza preselezionata sarebbe un'affermazione che nessuno ha fatto.",
  "assets.embargo": "Embargo fino al",
  "assets.embargoHint": "Facoltativo. Mentre corre, i byte sono per chi ci sta lavorando — editor e sopra — e a tutti gli altri si dice la data, non che il file non esiste.",
  "assets.embargoReason": "Perché",
  "assets.embargoReasonPlaceholder": "perché questi byte aspettano",
  "assets.deliverySigned": "Firmata — ogni file che atterra la eredita.",
  "assets.debt": "{stored} depositati, {signed} firmati.",
  "assets.debtHint": "{n} file sono nello store senza che si dica chi li ha fatti né cosa se ne può fare. Questo conto non sparisce se svuoti la lista.",
  "assets.state.pending": "{n} in attesa",
  "assets.state.stored": "{n} depositati",
  "assets.state.signed": "{n} firmati",
  "assets.state.failed": "{n} falliti",
  ...
  "sync.acceptLabel": "Accetto",
  "sync.acceptHint": "Cosa lasci atterrare in QUESTA finestra. In uscita non si trattiene più niente: quello che non mandi è invisibile all'altro capo, mentre quello che rifiuti all'arrivo è un rifiuto che vedi fare.",
  "sync.accept.nothing": "Niente",
  "sync.accept.selection": "Solo la selezione",
  "sync.accept.everything": "Tutto",
  "sync.acceptTitle.nothing": "dall'host non atterra niente; la tua roba esce lo stesso, e l'host decide cosa prendersi",
  "sync.acceptTitle.selection": "la selezione dell'host atterra qui; le sue modifiche al grafo no",
  "sync.acceptTitle.everything": "selezione e modifiche al grafo atterrano entrambe",
  "sync.acceptLogged": "dall'host accetto: {what}",
  "sync.hostAcceptTag": "l'host accetta",
  "sync.hostAcceptHint": "L'host rifiuta parte di quello che questo client manda. Quello che mandi arriva e viene rifiutato lì — non si perde per strada.",
  "sync.differentDocs": "I due capi hanno aperto documenti DIVERSI: {what}. Un node id che arriva di là non si trova qui — non è un errore, ma è il motivo per cui sembra non arrivare niente.",
  "sync.differentDocsToast": "Documenti diversi sui due capi — vedi il log",
  "sync.differentDocsTag": "documento diverso",
  "sync.differentDocsHint": "L'host e questo client hanno aperto grafi diversi. Lavorare su documenti diversi è legittimo; non saperlo è ciò che fa sembrare rotto il canale.",
  ...
  "shelf.empty": "Lo shelf è vuoto. Trascina qui un file dalla finestra Storage, o aggiungi un indirizzo con + URI nell’intestazione di questa finestra. Il browser mostra tutti i file del disco; lo shelf tiene quelli che hai scelto.",
  ...
  "shelf.nameTitle": "Il nome di questo shelf — viaggia con lo ShelfGraph quando lo salvi",
  "shelf.addUri": "+ URI",
  "shelf.addUriTitle": "Metti un indirizzo sullo shelf (URI/LOD)",
  "shelf.uriPlaceholder": "https://… (URI/LOD)",
