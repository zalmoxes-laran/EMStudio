...
const EN: Dict = {
  ...
  "ws.documentationHint": "Phase 1 — the material comes in: the disk, the room's store, a lot ingested with its licence, and the provenance of what was ingested.",
  "ws.analysis": "Analysis",
  "ws.analysisHint": "Phase 2 — the interpretation. Matrix, graph, DTC and the table are its windows and its modes: four ways of looking at one study, not four phases.",
  "ws.comparisons": "Comparisons",
  "ws.comparisonsHint": "Phase 3 — what is not yours: the shelf's three fences (own-study / own-HDT / other-HDT). Searching outside for sources is not here yet.",
  "ws.output": "Output",
  "ws.outputHint": "Phase 4 — what leaves the study: the narrative, and the exports that follow it.",
  "ws.viewNote": "a view, not a phase: an arrangement of the same material",
...
const IT: Dict = {
  ...
  "ws.documentationHint": "Fase 1 — il materiale entra: il disco, lo store della stanza, un lotto ingerito con la sua licenza, e la provenienza di ciò che è entrato.",
  "ws.analysis": "Analisi",
  "ws.analysisHint": "Fase 2 — l'interpretazione. Matrice, grafo, DTC e tabella sono le sue finestre e i suoi modi: quattro modi di guardare uno studio, non quattro fasi.",
  "ws.comparisons": "Confronti",
  "ws.comparisonsHint": "Fase 3 — quel che non è tuo: i tre recinti dello scaffale (own-study / own-HDT / other-HDT). La ricerca di fonti fuori non c'è ancora.",
  "ws.output": "Output",
  "ws.outputHint": "Fase 4 — quel che esce dallo studio: la narrativa, e gli export che la seguono.",
  "ws.viewNote": "una vista, non una fase: una disposizione dello stesso materiale",
